...
if ($ocenka!='' and $obj>0) {
 ...
 $db=mysqli_connect("localhost","root","j79ago43","Sofastore") or die();
 ...
 if ($number[0]==0) {
    ...
    $res=mysqli_query($db,"UPDATE Sofastore SET points=(points+".$ocenka."), votes=(votes+1) WHERE id=".$obj." LIMIT 1");
